...
const ShoppingCart = () => {
  const dispatch = useDispatch(); ///  is used to dispatch actions
  const cartItems = useSelector((state) => state.cart.cartItems); /// is used to extract data from the Redux store.
